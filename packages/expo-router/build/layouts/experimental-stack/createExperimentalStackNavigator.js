...
function ExperimentalStackNavigator({ id, initialRouteName, UNSTABLE_routeNamesChangeBehavior, children, layout, screenListeners, screenOptions, screenLayout, UNSTABLE_router, ...rest }) {
    ...
    return ((0, jsx_runtime_1.jsx)(NavigationContent, { children: (0, jsx_runtime_1.jsx)(ExperimentalStackView_1.ExperimentalStackView, { ...rest, state: state, navigation: navigation, descriptors: descriptors, describe: describe }) }));
}
